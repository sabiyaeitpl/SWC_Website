<?php
   ...
   $title = 'Blog';
   $manage_page = 'manage_blog.php';
   $table = 'blogs';
   $join_table = 'blog_categories';
   ...
   if(isset($_GET['type']) && $_GET['type']!=''){
    ...
    if($type=='search'){
		$id=get_safe_value($con,$_GET['id']);
		$sql="SELECT $join_table.name,$table.* FROM $table,$join_table where $table.category_id = $join_table.id and $table.category_id=$id order by $table.id desc";
                       ...
                       <div class="collapse d-md-block" id="displayOptions">
                           <div class="d-block d-md-inline-block">
                               <div class="btn-group float-md-left mr-1 mb-1">
                                   ...
                                   <?php
										$result=mysqli_query($con,"select id,name from blog_categories where status=1 order by name asc");
