   ...
   $breadcumb_title = 'Add '.$section_title;
    ...
    if(isset($_POST['submit'])){
        ...
        //	header('location:banner.php');
         ...
         <script>
        window.location.href='magazine_list.php';
        </script>
        <?php
            die();
        }
                            ...
                            <form action="" method="post" enctype="multipart/form-data" class="needs-validation tooltip-label-right" >
                                ...
                                <div class="form-group row">
                                    ...
                                    <select class="form-control" name="category_id" required>
										...
										<?php
										$res=mysqli_query($con,"select id,name from magazine_categories where status=1 order by name asc");
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="" name="year" value="<?php echo $year?>" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" >
                                    </div>
                                </div>
                                <div class="form-group row">
