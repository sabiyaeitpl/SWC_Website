<?php
   ...
   $table = 'magazine_categories';
   $section_title = 'Magazine Category';
   ...
   $breadcumb_title = 'Add '.$section_title;
    ...
    if(isset($_POST['submit'])){
        ...
        //	header('location:banner.php');
         ...
         <script>
        window.location.href='magazine_category.php';
        </script>
        <?php
            die();
        }
                ...
                <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <form action="" method="post" enctype="multipart/form-data" class="needs-validation tooltip-label-right" >
                              ...
                              if ($image!='') {
                              	echo "<a target='_blank' href='".MAGAZINE_IMAGE_SITE_PATH.$image."'><img width='100px' height='100px' src='".MAGAZINE_IMAGE_SITE_PATH.$image."'/></a>";
                              }
									 ?>
