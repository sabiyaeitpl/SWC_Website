                ...
                <div class="col-12">
                    <div class="mb-3">
                        ...
                        <div class="text-zero top-right-button-container">
                            <a href="manage_banner.php"><button type="button" class="btn btn-primary btn-lg top-right-button mr-1">ADD NEW</button></a>
                        </div>
            ...
            <div class="row">
                        ...
                        <div class="pl-2 d-flex flex-grow-1 min-width-zero">
                            <div
                                ...
                                <p class="mb-0 text-muted text-small w-15 w-sm-100">Heading-1</p>
                                     <p class="mb-0 text-muted text-small w-15 w-sm-100">Display Order</p>
                ...
                <?php while($row=mysqli_fetch_assoc($res)){ ?>
                    <div class="card d-flex flex-row mb-3">
                        <a class="d-flex" href="<?php echo BANNER_IMAGE_SITE_PATH.$row['image']?>" target="_blank">
                            <img src="<?php echo BANNER_IMAGE_SITE_PATH.$row['image']?>" alt="<?php echo $row['heading']?>"
                                class="list-thumbnail responsive border-0 card-img-left img-size-fixed" />
                        </a>
                        <div class="pl-2 d-flex flex-grow-1 min-width-zero">
                            <div
                                ...
                                <p class="mb-0 text-muted text-small w-15 w-sm-100"><?php echo $row['heading1']?></p>
                                    <p class="mb-0 text-muted text-small w-15 w-sm-100"><?php echo $row['order_by']?></p>
								...
								echo "<span class='badge badge-pill badge-info'><a href='manage_banner.php?id=".$row['id']."' class='badge-text-color'>Edit</a></span>&nbsp;";
