                ...
                <div class="col-12">
                    <div class="mb-3">
                        ...
                        <div class="text-zero top-right-button-container">
                            <a href="manage_about_why_choose_us.php"><button type="button" class="btn btn-primary btn-lg top-right-button mr-1">ADD NEW</button></a>
                        </div>
            ...
            <div class="row">
                     ...
                     <div class="card d-flex flex-row mb-3 element-to-hide">
                        ...
                        <div class="pl-2 d-flex flex-grow-1 min-width-zero">
                            <div
                                ...
                                <p class="mb-0 text-muted text-small w-15 w-sm-100">Heading</p>
                ...
                <?php while($row=mysqli_fetch_assoc($res)){ ?>
                    <div class="card d-flex flex-row mb-3">
                        <a class="d-flex" href="<?php echo WHY_IMAGE_SITE_PATH.$row['image']?>" target="_blank">
                            <img src="<?php echo WHY_IMAGE_SITE_PATH.$row['image']?>" alt="<?php echo $row['heading']?>"
                                class="list-thumbnail responsive border-0 card-img-left img-size-fixed" />
                        </a>
                        <div class="pl-2 d-flex flex-grow-1 min-width-zero">
                            <div
								...
								// }
								echo "<span class='badge badge-pill badge-info'><a href='manage_about_why_choose_us.php?id=".$row['id']."' class='badge-text-color'>Edit</a></span>&nbsp;";
