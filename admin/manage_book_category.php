        ...
        if($msg==''){
            ...
            if($_FILES['image']['name']!=''){
                    $image=rand(111111111,999999999).'_'.$_FILES['image']['name'];
                     if (!move_uploaded_file($_FILES['image']['tmp_name'], BOOK_CATEGORY_IMAGE_SERVER_PATH . $image)) {
                        throw new Exception("Failed to move the uploaded file.");
                    }else{
                        move_uploaded_file($_FILES['image']['tmp_name'],BOOK_CATEGORY_IMAGE_SERVER_PATH.$image);
                    }
                ...
                <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <form action="" method="post" enctype="multipart/form-data" class="needs-validation tooltip-label-right" >
                              ...
                              if ($image!='') {
                              	echo "<a target='_blank' href='".BOOK_CATEGORY_IMAGE_SITE_PATH.$image."'><img width='100px' height='100px' src='".BOOK_CATEGORY_IMAGE_SITE_PATH.$image."'/></a>";
                              }
									 ?>
