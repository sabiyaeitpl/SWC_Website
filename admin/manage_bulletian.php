<?php
   ...
   $breadcumb_title = 'Add '.$section_title;
    ...
    if(isset($_POST['submit'])){
        ...
        if($msg==''){
            if(isset($_GET['id']) && $_GET['id']!=''){
                mysqli_query($con,"update $table set description='$content' where id='$id'");
            }else{
                mysqli_query($con,"insert into $table(description,status) values('$content','1')");
            }
        //	header('location:banner.php');
                        ...
                        <div class="card-body">
                            ...
                            <form action="" method="post" enctype="multipart/form-data" class="needs-validation tooltip-label-right" >
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea name="content" id="editor" cols="30" rows="10" class="form-control"><?php echo $content ?></textarea>
                                    </div>
                                </div>
