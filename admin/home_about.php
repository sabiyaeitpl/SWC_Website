            ...
            <div class="row">
                <div class="col-12">
                    <div class="mb-3">
                        ...
                        <!--    <a href="manage_home_about.php"><button type="button" class="btn btn-primary btn-lg top-right-button mr-1">ADD NEW</button></a>-->
                        <!--</div>-->
            ...
            <div class="row">
                     ...
                     <div class="card d-flex flex-row mb-3 element-to-hide">
                        ...
                        <div class="pl-2 d-flex flex-grow-1 min-width-zero">
                            <div
                                ...
                                <p class="mb-0 text-muted text-small w-15 w-sm-100">Heading-1</p>
                                <p class="mb-0 text-muted text-small w-15 w-sm-100">Heading-2</p>
                ...
                <?php while($row=mysqli_fetch_assoc($res)){ ?>
                    <div class="card d-flex flex-row mb-3">
                        <a class="d-flex" href="<?php echo CONTENT_IMAGE_SITE_PATH.$row['image']?>" target="_blank">
                            <img src="<?php echo CONTENT_IMAGE_SITE_PATH.$row['image']?>" alt="<?php echo $row['heading']?>"
                                class="list-thumbnail responsive border-0 card-img-left img-size-fixed" />
                        </a>
                        <div class="pl-2 d-flex flex-grow-1 min-width-zero">
                            <div
                                class="card-body align-self-center d-flex flex-column flex-lg-row justify-content-between min-width-zero align-items-lg-center">
                                <p class="mb-0 text-muted text-small w-15 w-sm-100"><?php echo $row['heading1']?></p>
                                <p class="mb-0 text-muted text-small w-15 w-sm-100"><?php echo $row['heading2']?></p>
                                <!--<p class="mb-0 text-muted text-small w-15 w-sm-100"><?php echo $row['type']?></p>-->
								...
								// }
								echo "<span class='badge badge-pill badge-info'><a href='manage_home_about.php?id=".$row['id']."' class='badge-text-color'>Edit</a></span>&nbsp;";
