<?php
   ...
   $table = 'testimonials'; // table name
   $mange_page = 'manage_testimonials.php'; //manage page name 
            ...
            <div class="row">
                ...
                <?php while($row=mysqli_fetch_assoc($res)){ ?>
                    <div class="card d-flex flex-row mb-3">
                        <a class="d-flex" href="<?php echo TESTIMONIALS_IMAGE_SITE_PATH.$row['image']?>" target="_blank">
                            <img src="<?php echo TESTIMONIALS_IMAGE_SITE_PATH.$row['image']?>" alt="<?php echo $row['name']?>"
                                class="list-thumbnail responsive border-0 card-img-left img-size-fixed" />
                        </a>
                        <div class="pl-2 d-flex flex-grow-1 min-width-zero">
                            <div
