<?php
   ...
   $title = 'Services';
   $manage_page = 'manage_master_service.php';
   $table = 'services_master';

   $child_page = 'child_services.php';
   ...
   if(isset($_GET['type']) && $_GET['type']!=''){
    ...
    if($type=='search'){
		$user_type=get_safe_value($con,$_GET['user_type']);
		$sql="SELECT * FROM $table where type=$user_type order by id asc";
                                     ...
                                     <tr>
                                            ...
                                            <td>
                                                <?php
                                                    ...
                                                    echo "<span class='badge badge-pill badge-success'><a href='$child_page?master_id=".$row['id']."' class='badge-text-color' target='__blank'>Services</a></span>&nbsp;";
