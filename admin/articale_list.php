<?php
   ...
   $title = 'Article';
   $manage_page = 'manage_articale.php';
   $table = 'articales';
   $join_table = 'article_categories';
                       ...
                       <div class="collapse d-md-block" id="displayOptions">
                           <div class="d-block d-md-inline-block">
                               <div class="btn-group float-md-left mr-1 mb-1">
                                   ...
                                   <?php
										$result=mysqli_query($con,"select id,name from article_categories where status=1 order by name asc");
